...
# Path for amrex
export AMREX2D_HOME=$JOB_TREEDIR/software/AMReX/install/2D
export AMREX3D_HOME=$JOB_TREEDIR/software/AMReX/install/3D

# Path to flashx
export FLASHX_HOME=$JOB_TREEDIR/software/Flash-X
