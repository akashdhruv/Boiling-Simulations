...
# Path for amrex
export AMREX2D_HOME=$JOB_FILEDIR/software/amrex/install/2D
export AMREX3D_HOME=$JOB_FILEDIR/software/amrex/install/3D

# Path to flashx
export FLASHX_HOME=$JOB_FILEDIR/software/flashx
